...
# from backend.chatbot_graph import process_message  # Import the process_message function
...
#         # Process message and get response using the function from chatbot_graph.py
